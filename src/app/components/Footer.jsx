...
const Footer = () => {
  return (
    <div className='footer-container'>
        ...
        <p className='icons'>
          <a href="https://github.com/SuyashPatil-29" className='text-blue-500 hover:text-pink-500 hover:scale-125 transition-all ease-in-out duration-300' target="_blank" rel="noopener noreferrer"><AiFillInstagram /></a>
