  ...
  return (
    <div className="p-[100px] sm:p-[40px] rounded-[15px] h-[500px] leading-tight w-full bg-slate-300 bg-opacity-40 flex-row relative mx-auto">
      ...
      <div className='max-w-1/2'>
        <h1 className='lg:text-[4rem] md:text-[4rem] text-[2rem] mt-[4px] font-semibold text-gray-900'>{heroBanner.midText}</h1>
        <p className=' text-gray-900 lg:text-9xl md:text-9xl text-5xl lg:-ml-5 md:-ml-5 uppercase'>{heroBanner.discount}{heroBanner.largeText1}</p>
      </div>
        ...
        <div>
          ...
          <div className="desc">
            <p className='text-white text-2xl'>{heroBanner.desc}</p>
          </div>
        </div>
    </div>
  )
